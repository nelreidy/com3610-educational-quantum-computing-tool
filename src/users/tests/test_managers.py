...
class UsersManagersTests(TestCase):
    ...
    def test_create_superuser(self):
        ...
        with self.assertRaises(ValueError) as context:
            User.objects.create_superuser(email="fail@user.com", password="foo", is_staff=False)
        ...
        with self.assertRaises(ValueError) as context:
            User.objects.create_superuser(email="fail@user.com", password="foo", is_superuser=False)
